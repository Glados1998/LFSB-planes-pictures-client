...
const products = [

    {
        ...
        href: '#',
        price: '$48',
        imageSrc: 'https://images.unsplash.com/photo-1530545124313-ce5e8eae55af?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2671&q=80',
                    ...
                    <Dialog as="div" className="relative z-40 sm:hidden" onClose={setOpen}>
                        ...
                        <div className="fixed inset-0 z-40 flex">
                            ...
                            >
                                ...
                                <ChevronDownIcon
                                    className={classNames({classes: [open ? '-rotate-180' : 'rotate-0', 'h-5 w-5 transform']})}
                                    aria-hidden="true"
                                />
                              </span>
                                                            </Disclosure.Button>
                                                    ...
                                                    {({active}) => (
                                                        <a
                                                            ...
                                                            className={classNames(
                                                                {classes: [active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm font-medium text-gray-900']}
                                                            )}
                                                        >
                                                            {option.name}
                                                        </a>
